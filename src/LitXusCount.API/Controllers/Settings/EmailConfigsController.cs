...
[ApiController]
[Authorize]
[Route("api/settings/email-configs")]
public class EmailConfigsController(IEmailConfigService service) : ControllerBase
{
    [HttpGet]
    ...
    [HttpPost]
    [Authorize(Policy = "Permission." + Permissions.Settings.EmailConfig.Create)]
    public async Task<IActionResult> Create(EmailConfigUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.EmailConfig.Edit)]
    public async Task<IActionResult> Edit(long id, EmailConfigUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpDelete("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.EmailConfig.Delete)]
