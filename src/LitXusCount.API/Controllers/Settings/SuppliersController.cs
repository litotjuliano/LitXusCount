...
[ApiController]
[Authorize]
[Route("api/settings/suppliers")]
public class SuppliersController(ISupplierService service) : ControllerBase
{
    [HttpGet]
    [Authorize(Policy = "Permission." + Permissions.Settings.Supplier.View)]
    ...
    [HttpPost]
    [Authorize(Policy = "Permission." + Permissions.Settings.Supplier.Create)]
    public async Task<IActionResult> Create(SupplierUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.Supplier.Edit)]
    public async Task<IActionResult> Edit(long id, SupplierUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpDelete("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.Supplier.Delete)]
