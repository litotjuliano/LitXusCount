...
{
    [HttpGet]
    [Authorize(Policy = "Permission." + Permissions.Settings.Product.View)]
    ...
    [HttpPost]
    [Authorize(Policy = "Permission." + Permissions.Settings.Product.Create)]
    public async Task<IActionResult> Create(ProductUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.Product.Edit)]
    public async Task<IActionResult> Edit(long id, ProductUpsertDto request, CancellationToken ct)
    {
    ...
    [HttpDelete("{id:long}")]
    [Authorize(Policy = "Permission." + Permissions.Settings.Product.Delete)]
