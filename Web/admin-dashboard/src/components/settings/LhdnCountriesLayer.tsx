import { lhdnCountriesApi } from '../../api/settings/lhdnCountries'
import { usePaginatedQuery } from '../../hook/usePaginatedQuery'
import PaginatedTable from './PaginatedTable'

const LhdnCountriesLayer = () => {
  const pagedQuery = usePaginatedQuery(['settings', 'lhdn-countries'], lhdnCountriesApi.list)

  return (
    <div className='row'>
      <div className='col-12'>
        <PaginatedTable
          title='LHDN Country Codes'
          columns={[
...
export default LhdnCountriesLayer
